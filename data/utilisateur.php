...
classe `UTILISATEUR` : classe de gestion de l'objet utilisateur
...
class utilisateur extends _model {
    ...
    // Attributs
    protected $champs = ["nom", "login", "password", "role", "actif"]; // Liste des champs représentant l'utilisateur dans la BDD
    protected $table = "utilisateur"; // Table `UTILISATEUR`
